...
result=mlflow.register_model(logged_model, 'dbdemos.wesley_dias_databricks_com_retail_dlt.'+modelName, await_registration_for=0)
...
while True:
  model_version_details = client.get_model_version(name='dbdemos.wesley_dias_databricks_com_retail_dlt.'+modelName, version=result.version)
...
client.set_registered_model_alias('dbdemos.wesley_dias_databricks_com_retail_dlt.'+modelName, "production", 1)
